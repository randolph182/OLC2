...
public class Todos implements Expresion {
    ...
    public Todos(String idArreglo, Object idFuncion, int linea) {
                    ...
                    if (arreglo.getElementos().size() != 0) {
                        ...
                        for (int i = 0; i < arreglo.getElementos().size(); i++) {
                            ...
                            if (a != null) {
                                ...
                                if (rs.getValor(ent).toString().equalsIgnoreCase("false") || rs.getValor(ent).toString().equalsIgnoreCase("falso")) {
                                    flag = false;
                                    break;
                                }
                            }
